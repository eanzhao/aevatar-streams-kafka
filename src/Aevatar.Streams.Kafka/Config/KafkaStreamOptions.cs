...
namespace Orleans.Streams.Kafka.Config
{
	public class KafkaStreamOptions
	{
		...
		public TimeSpan PollTimeout { get; set; } = TimeSpan.FromMilliseconds(10);
		...
		public TimeSpan PollBufferTimeout { get; set; } = TimeSpan.FromMilliseconds(100);
		public bool MessageTrackingEnabled { get; set; } = false;
		...
		public TimeSpan BatchSizeAdjustmentInterval { get; set; } = TimeSpan.FromSeconds(30);
		public double BatchSizeAdjustmentFactor { get; set; } = 1.5;
		public bool EnableAdaptiveBatching { get; set; } = true;
		public bool EnableBatchMetrics { get; set; } = true;
